...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
                ...
                <tbody>
                    @foreach ($events as $event)
                        <tr>
                            ...
                            <td><a href="/events/{{ $event->id }}" class="event-title-field">{{ $event->title }}</a></td>
                            <td>{{ count($event->users) }}</td>
                            <td>
                                <a href="/events/edit/{{ $event->id }}" class="btn btn-info"><ion-icon
        ...
        @else
            <p>Você ainda não tem eventos, <a href="/events/create">criar eventos</a>
            </p>
        @endif
    </div>
    <div class="col-md-10 offset-md-1 dashboard-title-container">
